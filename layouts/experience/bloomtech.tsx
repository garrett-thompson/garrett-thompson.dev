  ...
  <div>
    ...
    <List className="mt-3">
      ...
      <Body>
        ...
        curriculum via various cron jobs & kafka event-based systems. Integrated
        with the Canvas LMS API.
      </Body>
      <Body>
        Created & shipped a few private npm libraries, including a React
        component library, a typed Canvas LMS client library, and an opinionated
        Kafka client suited to our needs.
      </Body>
    </List>
  </div>
);
